...
pub mod ffi {
    ...
    extern "Rust" {
        ...
        # [Self = QTableModelProxyRust]
        # [cxx_name = dropSelf]
        unsafe fn drop_self(self_ptr: *mut QTableModelProxyRust);
        # [cxx_name = index]
...
unsafe impl cxx::ExternType for QTableModelProxyRust {
    type Id = cxx::type_id!(QTableModelProxyRust);
